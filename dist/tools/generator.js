...
exports.generateHeadlineTool = void 0;
exports.generateHeadline = generateHeadline;
const zod_1 = require("zod");
exports.generateHeadlineTool = {
...
const HeadlineParamsSchema = zod_1.z.object({
    currentRole: zod_1.z.string(),
    skills: zod_1.z.array(zod_1.z.string()),
    targetKeywords: zod_1.z.array(zod_1.z.string()).optional(),
    style: zod_1.z.enum(['professional', 'creative', 'technical', 'leadership']).optional(),
    industry: zod_1.z.string().optional()
});
async function generateHeadline(params) {
    const { currentRole, skills, targetKeywords, style = 'professional', industry } = HeadlineParamsSchema.parse(params);
...
function extractHeadlineKeywords(headline) {
